...
def optimalNeighbor_ch123(lastOptimalNeighbor, pos, centerPoint):
    cut = int(len(lastOptimalNeighbor)/10)
...
def homogeneousPointsSearch(data, centerPoint):
    # filter_ch2 = optimalNeighbor_filtering(data, 4, centerPoint)
    homogeneous_ch2 = optimalNeighbor_ch123(data, 4, centerPoint)
    return homogeneous_ch2
