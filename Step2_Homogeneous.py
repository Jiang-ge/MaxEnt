...
def optimalNeighbor_ch123(lastOptimalNeighbor, pos, centerPoint):
    # cut = int(len(lastOptimalNeighbor)/400)
    cut = 90
    # if cut < 2:
...
def homogeneousPointsSearch(data, pos, centerPoint):
    # filter_e = optimalNeighbor_filtering(data, 3, centerPoint)
    # if len(filter_e) == 0:
    #     homogeneous_e = data
    # else:
    homogeneous = optimalNeighbor_ch123(data, pos, centerPoint)  # e
    # homogeneous = optimalNeighbor_ch123(homogeneous, pos, centerPoint)
    # homogeneous = optimalNeighbor_ch123(homogeneous, pos, centerPoint)
    return homogeneous
